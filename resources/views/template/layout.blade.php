...
<head>
  ...
  <link href="{{asset('../assets/modules/ionicons/css/ionicons.min.css')}}" rel="stylesheet">
          ...
          <ul class="sidebar-menu">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  <li><a class="nav-link" href="{{route('invventory')}}">Data Barang</a></li>
                  <li><a class="nav-link" href="{{route('product')}}">Produk</a></li>
                  <li><a class="nav-link" href="{{route('employee.index')}}">Pegawai</a></li>
                </ul>
              </li>
            </ul>
        </aside>
